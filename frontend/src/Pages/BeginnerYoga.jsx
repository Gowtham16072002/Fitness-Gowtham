  ...
  return (
    <>
      <div className='BeginnerYoga'>
        <div onClick={() => { navigate(ROUTES.KARMA_YOGA) }} className='karmayoga'>
          <div className='picture'>
            <img src={YogaDetail1} alt="" />
          </div>
          <div className="title">KARMA YOGA</div>
        </div>
        <div onClick={() => { navigate(ROUTES.BHAKTI_YOGA) }} className='bhaktiyoga'>
          <div className='picture'>
            <img src={YogaDetail2} alt="" />
          </div>
          <div className="title">BHAKTi YOGA</div>
        </div>
        <div onClick={() => { navigate(ROUTES.JNANA_YOGA) }} className='jnanayoga'>
          <div className='picture'>
            <img src={YogaDetail3} alt="" />
          </div>
          <div className="title">JNANA YOGA</div>
        </div>
        <div onClick={() => { navigate(ROUTES.PRICING_PLAN.replace(":name", "YogaTraining")); }} className='Membership'>
          <div className='picture'>
